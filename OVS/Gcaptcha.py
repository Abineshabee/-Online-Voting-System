...
def generate_captcha():
    ...
    captcha = ImageCaptcha(width=200, height=60, fonts=['arial.ttf'])  # Adjust width, height, and fonts for clearer image
    
    # Generate the CAPTCHA image
    captcha_image = captcha.generate(captcha_text)

    # Save the image to a file
    captcha_image_file = "D:\.vscode\OVS\static\images\captcha_image.png"  # Change the filename as needed
